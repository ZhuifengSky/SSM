...
public class Page<T> {
	...
	private int pageSize = Integer.valueOf(util.getPropertyValue("page.pageSize")); // 页面大小，设置为“-1”表示不进行分页（分页无效）
	...
	private List<T> extentlist = new ArrayList<T>();
...
//	}
    ...
    public List<T> getExtentlist() {
        return extentlist;
    }

    public void setExtentlist(List<T> extentlist) {
